...
class OdsButton extends LitElement {
    static get properties() {
        return {
            ...
            size: {
                type: String,
                converter: (value) => `oui-button_${value}`
            },
            type: {
                type: String
            },
    ...
    render() {
        return html`
            ...
            <button
              aria-label=${this.ifDefined(this.ariaLabel)}
              class=${this.getButtonClass()}
              @click=${this.onClick}
              ?disabled=${this.disabled}      
              id=${this.ifDefined(this.id)}
              name=${this.ifDefined(this.name)}
              type=${this.type}
              value=${this.ifDefined(this.value)}
            >            
